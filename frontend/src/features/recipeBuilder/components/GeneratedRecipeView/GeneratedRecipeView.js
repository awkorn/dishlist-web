        ...
        <div className={styles.recipeMeta}>
          {editableRecipe.prepTime && (
            <div className={styles.metaItem}>
              ...
              <span className={styles.metaValue}>
                {formatTime(editableRecipe.prepTime)}
              </span>
            </div>
          )}
          ...
          {editableRecipe.cookTime && (
            <div className={styles.metaItem}>
              ...
              <span className={styles.metaValue}>
                {formatTime(editableRecipe.cookTime)}
              </span>
            </div>
          )}
            ...
            <div className={styles.nutritionTable}>
              <div className={styles.nutritionRow}>
                ...
                <span className={styles.nutritionValue}>
                  {editableRecipe.nutrition.calories}
                </span>
              </div>
              <div className={styles.nutritionRow}>
                <span className={styles.nutritionLabel}>Protein:</span>
                <span className={styles.nutritionValue}>
                  {editableRecipe.nutrition.protein}g
                </span>
              </div>
              <div className={styles.nutritionRow}>
                <span className={styles.nutritionLabel}>Carbohydrates:</span>
                <span className={styles.nutritionValue}>
                  {editableRecipe.nutrition.carbs}g
                </span>
              </div>
              <div className={styles.nutritionRow}>
                <span className={styles.nutritionLabel}>Fat:</span>
                <span className={styles.nutritionValue}>
                  {editableRecipe.nutrition.fat}g
                </span>
              </div>
            </div>
          </div>
